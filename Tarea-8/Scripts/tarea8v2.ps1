...
$RUTA_CSV      = "C:\Users\Administrador\Administracion-de-Sistemas\Tarea 8 - Gobernanza, Cuotas y Control de Aplicaciones en Active Directory\Scripts\usuarios.csv"
